...
#ifdef GPUQO_PROFILE
#define DECLARE_TIMING(s)  		time_point timeStart_##s; double timeDiff_##s; double timeTotal_##s = 0; int count_##s = 0; double timeCheckpoint_##s = 0; int countCheckpoint_##s = 0
